...
namespace SkewedQubitOperations
{
    ...
    internal class __QsEntryPoint__ : Microsoft.Quantum.EntryPointDriver.IEntryPoint<Double, Result>
    {
        ...
        public EntryPointInfo<Double, Result> Info => global::SkewedQubitOperations.GenerateSpecificState.Info;
        ...
        private static async System.Threading.Tasks.Task<int> Main(string[] args) => await new Microsoft.Quantum.EntryPointDriver.Driver<global::SkewedQubitOperations.GenerateSpecificState, Double, Result>(new Microsoft.Quantum.EntryPointDriver.DriverSettings(simulatorOptionAliases: System.Collections.Immutable.ImmutableList.Create("--simulator", "-s"), quantumSimulatorName: "QuantumSimulator", toffoliSimulatorName: "ToffoliSimulator", resourcesEstimatorName: "ResourcesEstimator"), new __QsEntryPoint__()).Run(args);
    }
}